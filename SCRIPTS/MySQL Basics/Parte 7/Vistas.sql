#Crear BD en caso que no exista y utilizarla
...
#Crear Tablas (Secciones y empleados)
 ...
 #Insertar Valores en las tablas (Secciones y empleados)
...
#Se creara una vista llamada vista_empleado y se mostraran cuatro campos
...
#Muestra todos los valores dentro de la vista
select * from vista_empleado;
#Selecciona la seccion, y la cantidad de empleados por seccion
...
#Ver todos los empleados que tengan mas de un hijo
create view vista_empleadosconhijos as (select nombre, seccion, cantidadhijos from vista_empleado where cantidadhijos>0);
...
select * from vista_empleadosconhijos;
